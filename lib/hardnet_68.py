    ...
    def __init__(self, depth_wise=False, arch=85, pretrained=True, weight_path=''):
        ...
        self.base.append(
            ConvLayer(in_channels=3, out_channels=first_ch[0], kernel=3,
                      stride=2, bias=False))
        # print( (ConvLayer(in_channels=3, out_channels=first_ch[0], kernel=3,stride=2,  bias=False)))
...
#         if pretrained:
#             # weights = torch.load('/home/415/wyy/polyp/hardnet68.pth')
#             weights = torch.load('D:/wyy/Pytorch-HarDNet-master/hardnet68.pth')
...
def hardnet(arch=68, pretrained=True, **kwargs):
    if arch == 68:
        ...
        if pretrained:
            ...
            weights = torch.load('D:/wyy/Pytorch-HarDNet-master/hardnet68.pth', map_location=device)
            model.load_state_dict(weights)
            print("68 LOADED READY")
    return model